...
export default function RegisterPage() {
  const { register, translations, isAuthenticated, isSurveyCompleted } = useApp();
        ...
        <Card className="w-full max-w-md shadow-lg border-2">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <CardFooter className="flex flex-col gap-4">
              <Button type="submit" className="w-full" disabled={isLoading}>{isLoading ? 'Hesap oluşturuluyor...' : translations.createAccount}</Button>
